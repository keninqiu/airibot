  ...
  for (const query of queries) {
    ...
    if (!promise) {
      ...
      promise = promise.then(responses => {
        console.log('Detected intentsss');
...
streamingDetectIntent:function(
  projectId,
  sessionId,
  filename,
  encoding,
...
logQueryResult:function(sessionClient, result) {
  // Imports the Dialogflow library
  const dialogflow = require('dialogflow');
